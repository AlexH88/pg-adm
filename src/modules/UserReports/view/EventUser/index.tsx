...
function mapState(state: IReduxState): IStateProps {
  ...
  return {
    ...
    configHeaders: getHeadersConfig('userlogs', state),
...
class EventUser extends React.PureComponent<Props, {}> {
  ...
  @bind
  private renderFormatter(field: any, row: any) {
...
export { EventUser };
export default connect<IStateProps, IDispatchProps, {} >(mapState, mapDispatch)(EventUser);
