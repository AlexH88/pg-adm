...
function mapState(state: IReduxState): IStateProps {
  ...
  return {
    ...
    headers: ShowResourceSelectors.getHeaders(state, 'printer_reports'),
    configHeaders: getHeadersConfig('printer_reports', state),
...
function mapDispatch(dispatch: any): IDispatchProps {
  return bindActionCreators({
    ...
    sendRegularForm: injectResource('printer_reports', actions.sendRegularForm),
    startSaveReportForm: actions.startSaveReportForm,
    sendReportForm: injectResource('printer_reports', actions.sendReportForm),
    changeTableHeaders: injectResource('printer_reports', ShowResourceActions.changeHeader),
    startSaveRegularForm: injectResource('printer_reports', actions.startSaveRegularForm)
  }, dispatch);
}

class PrinterTotalStats extends React.PureComponent<Props, {}> {
    ...
    return (
      <div className={b()}>
        <FilterResource
          ...
          resource="printer_reports"
          changeHeaderByFilter={this.changeHeaderByFilter}
          label="Отчеты > Статические > По принтерам"
        />
        <ShowResource
          resource="printer_reports"
          headers={headers}
        ...
        >
        {
          ...
          <AddReportForm
            ...
            onSave={sendReportForm.bind(null, "printer_reports")}
          />
        }
        </Modal>
        <Modal
        ...
        // @ts-ignore
          <AddRegularForm
            ...
            onSave={sendRegularForm.bind(null, "printer_reports")}
          />
        </Modal>
        <Modal
            isOpen={showPdfModal}
...
export { PrinterTotalStats };
export default connect<IStateProps, IDispatchProps, {} >(mapState, mapDispatch)(PrinterTotalStats);
