...
function mapState(state: IReduxState): IStateProps {
  ...
  return {
    ...
    configHeaders: getHeadersConfig('agentlogs', state),
...
class EventAgent extends React.PureComponent<Props, {}> {
...
export { EventAgent };
export default connect<IStateProps, IDispatchProps, {} >(mapState, mapDispatch)(EventAgent);
