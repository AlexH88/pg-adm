...
class TotalStats extends React.PureComponent<Props, {}> {
    ...
    return (
      <div className={b()}>
        <FilterResource
          ...
          label="Отчеты > Статические > По пользователям"
        />
        <ShowResource
          resource="user_reports"
          headers={headers}
        ...
        // @ts-ignore
          <AddRegularForm
            ...
            onSave={sendRegularForm.bind(null, "user_reports")}
          />
        </Modal>
        {
...
export { TotalStats };
export default connect<IStateProps, IDispatchProps, {} >(mapState, mapDispatch)(TotalStats);
