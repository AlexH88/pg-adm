    ...
    return (
      <form onSubmit={this.handleSubmit} className={b()} >
        <div className={b('groups-wrapper')}>
          <Field
            label={i18next.t('EditRuleForm.printergroups')}
            name="printergroups"
            value={printerGroupsForm}
            component={this.renderPrinterGroups}
          />
          <Field
            label={i18next.t('EditRuleForm.usergroups')}
            name="usergroups"
        ...
        <Field
          label={i18next.t('EditRuleForm.days')}
          name="days"
        ...
        />
        <Field
          label={i18next.t('EditRuleForm.hours')}
          name="hours"
          format={this.formatHours}
          value={hours}
          component={this.renderHoursField}
        />
        <Field label={i18next.t('EditRuleForm.action')} name="action" component={this.renderActionField}/>
        <Field name="alert" component={this.renderCheckbox} type="checkbox"/>
        <span className={b('general-error')}>{error}</span>
        <div className={b('footer')}>
          <Button
            label={i18next.t('EditRuleForm.cancel')}
            onClick={this.handleCancel}
          />
          <Button
            label={i18next.t('EditRuleForm.save')}
