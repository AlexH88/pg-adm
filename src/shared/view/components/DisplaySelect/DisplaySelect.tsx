...
class DisplaySelect extends React.Component<Props, {}> {
    ...
    return (
      <div className={b()}>
        <div className={b('multiselect')}>
          <CheckboxMultiselect
            values={headers}
            title={title ? title : `${i18next.t('DisplaySelect.content')}`}
...
export default connect<IStateProps, IDispatchProps, IOwnProps >(mapStateToProps, mapDispatchToProps)(DisplaySelect);
